...
create table players (birthday date, id bigint not null auto_increment, firstname varchar(255), lastname varchar(255), gender enum ('MAN','WOMAN'), primary key (id)) engine=InnoDB;
